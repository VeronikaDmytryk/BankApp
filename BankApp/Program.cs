...
namespace BankApp
{
    class Program
    {
            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case "1":
                        ...
                        Console.WriteLine($"AN: {account.AccountNumber}, Balance: {account.Balance}, Type: {account.AccountType}");
                        break;
                    case "2":
                        PrintAllAccounts();
        ...
        private static void PrintAllAccounts()
        {
            ...
            {
                Console.WriteLine($"AN: {acnt.AccountNumber}, Balance: {acnt.Balance}, Type: {acnt.AccountType}");
            }
        }
    }
}
